    ...
    <div className='space-y-4 relative md:static top-20'>
      ...
      <div className='w-full space-y-4'>
        ...
        <div className='space-y-2'>
          ...
          <div className='space-x-1 text-[1rem] font-medium'>
            <input id='PartsPro' type='radio' name='brand' value='Parts Pro' />
          ...
          <div className='space-x-1 text-[1rem] font-medium'>
            <input id='Precision' type='radio' name='brand' value='Precision' />
          ...
          <div className='space-x-1 text-[1rem] font-medium'>
            <input id='AutoMates' type='radio' name='brand' value='AutoMates' />
      ...
      <div className='w-full space-y-4'>
        ...
        <div className='space-y-2 '>
          <div className='space-x-1 text-[1rem] font-medium'>
            <input id='battery' type='radio' name='category' value='battery' />
