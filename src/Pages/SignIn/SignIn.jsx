      ...
      <div className=" w-full lg:w-fit bg-white shadow-lg overflow-hidden rounded-md lg:grid grid-cols-2 gap-4">
        ...
        <div className="bg-white shadow rounded w-full p-10 ">
          ...
          <div className="mt-8">
            <button
              role="button"
              className="focus:ring-2 bg-error focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none  border rounded hover:bg-rose-600 py-4 w-full transition-colors duration-300"
            >
              Login to your account
            </button>
          </div>
